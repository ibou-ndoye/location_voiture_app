...
<div class="container mt-5">
    <h2 class="mb-4">Passer une commande de location</h2>

    <form action="${pageContext.request.contextPath}/passerCommande" method="post" class="row g-3" id="formCommande" oninput="calculerPrix()">
...
<script>
    // Met à jour le kilométrage de départ selon la voiture sélectionnée
    ...
    // Calcule le prix total en fonction des dates et prix/jour
    ...
    // Empêche la soumission du formulaire si voiture ou client non sélectionnés
